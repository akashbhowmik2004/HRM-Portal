...
const TopHeader = ({
  ...
  return (
    <header className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between rounded-xl bg-white/80 dark:bg-[#151d2e] p-3 sm:px-5 border border-gray-100/80 dark:border-gray-800/50 shadow-soft backdrop-blur-sm transition-colors">
      {/* Left: Mobile Menu & Navigation Shortcuts */}
      ...
      {/* Center/Search: Pill search input */}
